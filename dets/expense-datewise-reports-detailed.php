...
<head>
	...
	<title>PiggySave || Datewise Expense History</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Datewise Expense History</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Datewise Expense History</div>
...
?>
<h5 align="center" style="color:blue">Datewise Expense History from <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
